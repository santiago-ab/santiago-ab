 ...
 */
public class EliminarPI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("Pi1");
        jScrollPane3.setViewportView(jTextPane1);

        jTextPane3.setText("Pi10");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarPI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarPI().setVisible(true);
            }
        });
    }
